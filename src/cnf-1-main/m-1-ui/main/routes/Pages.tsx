...
export const pages: PageType[] = [
    ...
    // {
    //     id: 3, title: 'profile', path: PATH.PROFILE, params: '/:id', exact: true,
    ...
    // {id: 4, title: 'packs', path: PATH.PACKS, exact: true, page: () => <PacksPage/>},
    // {id: 5, title: 'cards', path: PATH.CARDS, params: '/:id', exact: true, page: () => <CardsPage/>},
    // {id: 6, title: 'learn', path: PATH.LEARN, params: '/:id', exact: true, page: () => <LearnPage/>},
